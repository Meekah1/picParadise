...
//         ipfs = MerkleDAG(_ipfsAddress);
//     }

//     function storePhoto(bytes memory _photo) public returns (bytes32) {
//         // Add the photo to IPFS
//         bytes32 hash = ipfs.add(_photo);

//         // Return the IPFS hash of the photo
//         return hash;
//     }

//     function getPhoto(bytes32 _hash) public view returns (bytes memory) {
//         // Get the photo from IPFS
//         bytes memory photo = ipfs.get(_hash);
